...
class Bm_Acf_Page_Builder {
	 ...
	 *
	 * - Bm_Acf_Page_Builder_Loader. Orchestrates the hooks of the plugin.
	 * - Bm_Acf_Page_Builder_i18n. Defines internationalization functionality.
	 * - Bm_Acf_Page_Builder_Admin. Defines all hooks for the admin area.
	 * - Bm_Acf_Page_Builder_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-bm-acf-page-builder-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-bm-acf-page-builder-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-bm-acf-page-builder-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-bm-acf-page-builder-public.php';

		$this->loader = new Bm_Acf_Page_Builder_Loader();
	...
	private function set_locale() {
		...
		$plugin_i18n = new Bm_Acf_Page_Builder_i18n();
