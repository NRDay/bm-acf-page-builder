...
class bm_acf_field_post_type_selector extends acf_field {
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting( $field, array(
			...
			'name'			=> 'select_type',
			'choices' => array(
				bm_acf_field_post_type_selector::SELECTOR_TYPE_SELECT => __( 'Select' ),
				bm_acf_field_post_type_selector::SELECTOR_TYPE_RADIO => __( 'Radio' ),
				bm_acf_field_post_type_selector::SELECTOR_TYPE_CHECKBOXES => __( 'Checkboxes' ),
			)
		));
	}
	...
	*/
	...
	function render_field( $field ) {
		...
		switch ( $field[ 'select_type' ] ) {
			...
			case bm_acf_field_post_type_selector::SELECTOR_TYPE_SELECT:
			...
			case bm_acf_field_post_type_selector::SELECTOR_TYPE_RADIO:
			...
			case bm_acf_field_post_type_selector::SELECTOR_TYPE_CHECKBOXES:
...
// create field
new bm_acf_field_post_type_selector();
