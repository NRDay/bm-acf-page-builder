function initialize_typography( $el ) {
	...
	*/
	...
	$(".sizeF").each(function(){
	    $(this).on("input",function(){
			...
			$(this).closest(":has(.rey_main .acf-typography-preview .preview_font)").find("iframe").attr( "src", phpVar.dir + "typo-preview.php?css="+css+"&font="+name+"&wi="+stl);
		});
	});
	 ...
	 */
		 function preview(name , stl, thisF) {
			...
			thisF.closest(":has(.rey_main .acf-typography-preview .preview_font)").find("iframe").attr( "src", phpVar.dir + "typo-preview.php?css="+css+"&font="+name+"&wi="+stl);
		}
	}
}